...
(function ($) {
  ...
  function toEnglishNumber(inputNumber2) {
    ...
    if (str == "") return "";
    str = str.replace(/0/img, '0');
    str = str.replace(/1/img, '1');
    str = str.replace(/2/img, '2');
    str = str.replace(/3/img, '3');
    str = str.replace(/4/img, '4');
    str = str.replace(/5/img, '5');
    str = str.replace(/6/img, '6');
    str = str.replace(/7/img, '7');
    str = str.replace(/8/img, '8');
    str = str.replace(/9/img, '9');
    return str;
  }
