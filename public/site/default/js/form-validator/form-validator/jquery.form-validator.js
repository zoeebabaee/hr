...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    parseDate: function (val, dateFormat, addMissingLeadingZeros) {
      ...
      if ((month === 2 && day > 31 && (year % 4 !== 0 || year % 100 === 0 && year % 400 !== 0)) ||
        (month === 2 && day > 31 && (year % 4 === 0 || year % 100 !== 0 && year % 400 === 0)) ||
        month > 12 || month === 0) {
        return false;
      }
      if ((this.isShortMonth(month) && day > 31) || (!this.isShortMonth(month) && day > 31) || day === 0) {
        return false;
      }
