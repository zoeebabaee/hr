        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش کتاب </h1>
                    <hr>

                    {{ Form::model($book, ['route' => ['books.update', $book->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group-lg col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group rtl-input input-sx">
                                  <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail1" class="form-control input-sm" type="text" value="{{$book->img}}" name="img" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                                </div>

                                @if($book->img=="")
                                    <img id="holder1" style="margin-top:15px;max-height:100px;" src="/GolrangSystem-File-Manager/photos/1/default/noimage_news.png">
                                @else
                                    <img id="holder1" style="margin-top:15px;max-height:100px;" src="{{$book->img}}" >
                                @endif
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="book_name" class="form-control" value="{{$book->book_name}}" type="text" style="max-width:300px;" />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="slug" class="form-control" value="{{$book->slug}}" type="text" style="max-width:300px;" />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{$book->release_date}}" class="form-control ltr-input" id="release_date" name="release_date" />
                                    </div>
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('publication_name', $book->publication_name, array('class' => 'form-control')) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                {{ Form::text('tags', implode(' ',$book->tags->pluck('name')->toArray()), array('class' => 'form-control','id'=>'tags')) }}
                            </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            {{ Form::textarea('body',$book->body, array('class' => 'form-control')) }}
                        </div>
                    </div>
