    ...
    <div class="col-xs-12 wrapper wrapper-content animated fadeInLeft white-bg">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <a href="{{ route('books.create') }}" class="btn btn-info"><i class="fa fa-newspaper-o"></i>
                    &nbsp;&nbsp;
                    جدید</a>
                        ...
                        @foreach($books as $book)
                            ...
                            <tr class="gradeX">
                                ...
                                <td style="white-space: nowrap;width:170px;">
                                    ...
                                    <a href="{{ route('books.edit', $book->id) }}" class="btn btn-info btn-sm pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i></a>

                                    <a href="javascript:void(0);" cat_id="{{$book->id}}" route="{{route('books.destroy', $book->id)}}"  class="btn btn-info btn-sm pull-left btn btn-danger btn-sm pull-left confirm_alert" style="margin-right: 3px;"><i class="fa fa-trash"></i></a>
