        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش دپارتمان</h1>
                    <hr>

                    {{ Form::model($department, ['route' => ['departments.update', $department->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="col-lg-6">
                        <div class="input-group rtl-input input-sx">
                          <span class="input-group-btn">
                            ...
                            <input id="thumbnail1" class="form-control input-sm" type="text" value="{{$department->image}}" name="image" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                        </div>
                        @if($department->image=="")
                            <img id="holder1" style="margin-top:15px;max-height:100px;" src="/GolrangSystem-File-Manager/photos/1/default/noimage_news.png">
                        @else
                            <img id="holder1" style="margin-top:15px;max-height:100px;" src="{{$department->image}}">
                        @endif
