    ...
    <div class="col-xs-12 wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li  class="active">
                    <a><strong>ویرایش کد ملی جدید</strong></a>
                </li>
    ...
    <div class="col-xs-12 wrapper wrapper-content animated fadeInLeft white-bg">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1><i class='fa fa-key'></i> ویرایش کدملی جدید</h1>
                <br>

                {{ Form::open(array('route' => ['worker-list.update',$workerList->id],'id'=>'create-form')) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('national_code', $workerList->national_code, ['class' => 'form-control','maxLength'=>'10','autocomplete'=>'off']) }}
                    <label id="codemelli_error" class="error"></label>
                </div>

                <div class="form-group">
                    {{ Form::label('company_id', 'شرکت') }}
                    {{ Form::select('company_id', $companies,$workerList->company_id, ['class' => 'form-control']) }}
                </div>
