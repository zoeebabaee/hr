        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش آیتم گالری</h1>
                    <hr>

                    {{ Form::model($gallery, ['route' => ['gallery.update', $gallery->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group-lg col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group rtl-input input-sx">
                                  <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail1" class="form-control input-sm" value="{{$gallery->img}}" type="text"  name="img" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                                </div>

                                <img id="holder1" style="margin-top:15px;max-height:100px;" src="{{$gallery->img}}">
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('link', old('link')?old('link'):$gallery->link, array('class' => 'form-control')) }}
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('name', old('name')?old('name'):$gallery->name, array('class' => 'form-control')) }}
                                </div>
                            </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            {{ Form::textarea('body',old('body')?old('body'):$gallery->body, array('class' => 'form-control')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="cat_id" id="cat_id">
                            ...
                            @foreach(\HR\GalleryCategory::all() as $cat)
                                <option value="{{ $cat->id }}" {{ old('cat_id')? $cat->id==old('cat_id')?'selected':'': $cat->id==$gallery->cat_id?'selected':''}}>{{ $cat->name }}</option>
                            @endforeach
                        </select>
                    </div>
