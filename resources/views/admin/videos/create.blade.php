                    ...
                    <div class="form-group-lg col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group rtl-input input-sx">
                                  <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail1" class="form-control input-sm" type="text" value="{{old('avatar')}}" name="avatar" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                {{ Form::textarea('video',old('video'), array('class' => 'form-control','style'=>'direction:ltr')) }}
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="gallery_id" id="gallery_id">
                                        ...
                                        @foreach(\HR\VideoGallery::all() as $cat)
                                            <option value="{{ $cat->id }}" {{  ($cat->id==old('gallery_id')?'selected':'') }}>{{ $cat->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
