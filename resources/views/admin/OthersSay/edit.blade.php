        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                    ...
                    {{ Form::model($qoute, ['route' => ['OthersSay.update', $qoute->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group-lg col-lg-12">
                          ...
                          <span class="input-group-btn">
                            <a id="lfm1" data-input="thumbnail1" data-preview="holder1" class="btn btn-primary">
                              <i class="fa fa-picture-o"></i> تصویر
                                    ...
                                    <input id="thumbnail1" class="form-control input-sm" value="{{$qoute->avatar}}" type="text" name="avatar" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                                </div>
                                <img id="holder1" src="{{$qoute->avatar}}" style="margin-top:15px;max-height:100px;">
                            </div>
                            ...
                            <div class="form-group">
                                {{ Form::label('name', 'نام') }}
                                <input name="name" class="form-control icp icp-auto" value="{{$qoute->name}}" type="text" style="max-width:300px;"/>
                            </div>

                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    {{ Form::label('post', 'سمت') }}
                                    {{ Form::text('post', $qoute->post, array('class' => 'form-control')) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('company', $qoute->company, array('class' => 'form-control')) }}
                                </div>
                            </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            {{ Form::textarea('body',$qoute->body, array('class' => 'form-control')) }}
                        </div>
                    </div>
