        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                    ...
                    {{ Form::model($faq, ['route' => ['faqs.update', $faq->id], 'method' => 'PUT','class'=>'form']) }}
                    ...
                    <div class="form-group-lg col-lg-12">
                        ...
                        <div class="form-group-lg col-lg-12">
                            <div class="form-group col-lg-12">
                                ...
                                {{ Form::textarea('question',$faq->question, array('class' => 'form-control')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group-lg col-lg-12">
                            <div class="form-group col-lg-12">
                                ...
                                <div style="color:red;padding:5px;">جهت جلوگیری از به هم ریختگی متون در سایت،هرگز نام فونت را تغییر ندهید.تغییر اندازه ی فونت مانعی ندارد.</div>
                                {{ Form::textarea('answer',$faq->answer, array('class' => 'form-control')) }}
                            </div>
                        </div>
                    </div>
