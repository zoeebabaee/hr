        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش شایستگی تخصصی</h1>
                    <hr>

                    {{ Form::model($professionalMerite, ['route' => ['professionalMerites.update', $professionalMerite->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('name', 'نام') }}
                        {{ Form::text('name', $professionalMerite->name, array('class' => 'form-control')) }}
                    </div>
