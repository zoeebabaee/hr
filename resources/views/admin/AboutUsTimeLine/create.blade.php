        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ایجاد تایم لاین</h1>
                    <hr>
                    ...
                    <div class="form-group-lg col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group rtl-input input-sx">
                                  <span class="input-group-btn">
                                    ...
                                    <input id="thumbnail1" class="form-control input-sm" type="text" value="" name="img" style="font:9pt 'courier new';text-align:left;direction:ltr;">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="icon" class="form-control icp icp-auto" value="" type="text" style="max-width:300px;text-align:left;direction:ltr;"/>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('when', old('when'), array('class' => 'form-control')) }}
