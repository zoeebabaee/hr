        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-12">
                        ...
                        <h1><i class='fa fa-user-md'></i>&nbsp;ایجاد مجموعه</h1>
                        <hr>

                        {{ Form::open(array('route' => 'content_categories.store','files' => true)) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('status', [1=>'منتشر شده',2=>'منتشر نشده',3=>'حذف شده'],null, array('class' => 'form-control')) }}
                    </div>

                        <div class="form-group">
                            {{ Form::label('layout', 'Layout') }}
                            {{ Form::select('layout', ['News'=>'news','Blog'=>'blog','Events'=>'events'],null, array('class' => 'form-control')) }}
                        </div>

                        <div class="form-group">
                            {{ Form::label('comment_enable', 'فعال بودن نظرات') }}
                            {{ Form::select('comment_enable', ['0'=>'خیر','1'=>'بله'],null, array('class' => 'form-control')) }}
                        </div>
