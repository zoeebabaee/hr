...
@section('content')
    ...
    <div class="col-xs-12 wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>مدیریت شایستگی های عمومی</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="#">
                        خانه</a>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ایجاد شایستگی عمومی</h1>
                    <hr>

                    {{ Form::open(array('route' => 'generalMerites.store','files' => true)) }}
