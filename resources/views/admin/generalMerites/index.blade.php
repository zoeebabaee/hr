...
@section('content')
    <div class="col-xs-12 wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li  class="active">
                    <a><strong>
                            لیست شایستگی های عمومی</strong></a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {{ Form::model($generalMerites, array('route' => array('generalMerites.search'), 'method' => 'GET','class'=>'form-inline')) }}
            ...
            <div class="col-lg-12">
                @if(auth()->user()->hasRole('سوپرادمین'))
                    <a href="{{ route('generalMerites.create') }}" class="btn btn-info"><i
                                class="fa fa-newspaper-o"></i>
                        &nbsp;
                        جدید</a>
                @endif
   <a href="{{ route('generalMerites.export') }}" class="btn btn-info" style="background-color: green"><i class="fa fa-newspaper-o"></i>
       &nbsp;
       Export</a>
   <br><br>
   ...
   <div class="table-responsive" >
       <table class="table table-striped table-bordered table-hover" style="margin-bottom: 300px">
           ...
           @foreach($generalMerites as $generalMerite)

               <tr class="gradeX">

                   <td><strong>{{$generalMerite->name}}
                           @if($generalMerite->jobs->count())
                               <span style="color: red;">(استفاده شده)</span>
                           @endif</strong>
                   </td>

                   <td>
                       {!! Form::open(['method' => 'POST', 'route' => ['generalMerites.replace', $generalMerite->id] ]) !!}
                       {{  Form::select('with', $ptrs,null, array('class' => 'form-control chosen')) }}
                   ...
                   <td style="white-space: nowrap;width:120px;">
                       ...
                       @if($generalMerite->deleted_at==null)
                           <a href="{{ route('generalMerites.edit', $generalMerite->id) }}" class="btn btn-info btn-sm pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i></a>
                       @endif

                       @if($generalMerite->deleted_at==null)

                           <a href="javascript:void(0);" cat_id="{{$generalMerite->id}}" route="{{route('generalMerites.destroy', $generalMerite->id)}}"  class="btn btn-info btn-sm pull-left btn btn-danger btn-sm pull-left confirm_alert" style="margin-right: 3px;"><i class="fa fa-trash"></i></a>

                       @else

                           {!! Form::open(['method' => 'POST', 'route' => ['generalMerites.restore', $generalMerite->id] ]) !!}
       ...
       {!! $generalMerites->links() !!}

   </div>

   <a href="{{ route('generalMerites.create') }}" class="btn btn-info"><i class="fa fa-newspaper-o"></i>
       &nbsp;
       جدید</a>
   <a href="{{ route('generalMerites.export') }}" class="btn btn-info" style="background-color: green"><i class="fa fa-newspaper-o"></i>
       &nbsp;
       ...
       function (isConfirm) {
           if (isConfirm) {
               ...
               $.ajax({
                   ...
                   data: 'generalMerite=' + cat_id + '&_token={{csrf_token()}}',
