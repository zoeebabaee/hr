            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {{ Form::model($organizationalCategories, array('route' => array('organizationalCategories.search'), 'method' => 'GET','class'=>'form-inline')) }}
            ...
            <div class="col-lg-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" >
                        ...
                        @foreach($organizationalCategories as $organizationalCategory)

                            <tr class="gradeX">

                                <td><strong>{{$organizationalCategory->name}}</strong></td>

                                <td style="white-space: nowrap;width:120px;">

                                    @if($organizationalCategory->deleted_at==null)
                                        <a href="{{ route('organizationalCategories.edit', $organizationalCategory->id) }}" class="btn btn-info btn-sm pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i></a>
                                    @endif

                                    @if($organizationalCategory->deleted_at==null)

                                        <a href="javascript:void(0);" cat_id="{{$organizationalCategory->id}}" route="{{route('organizationalCategories.destroy', $organizationalCategory->id)}}"  class="btn btn-info btn-sm pull-left btn btn-danger btn-sm pull-left confirm_alert" style="margin-right: 3px;"><i class="fa fa-trash"></i></a>

                                    @else

                                        {!! Form::open(['method' => 'POST', 'route' => ['organizationalCategories.restore', $organizationalCategory->id] ]) !!}
                    ...
                    {!! $organizationalCategories->links() !!}

                </div>

                <a href="{{ route('organizationalCategories.create') }}" class="btn btn-info"><i class="fa fa-newspaper-o"></i>
                    &nbsp;
                    جدید</a>
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            $.ajax({
                                ...
                                data: 'organizationalCategory=' + cat_id + '&_token={{csrf_token()}}',
