        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش رده ی سازمانی</h1>
                    <hr>

                    {{ Form::model($organizationalCategory, ['route' => ['organizationalCategories.update', $organizationalCategory->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('name', 'نام') }}
                        {{ Form::text('name', $organizationalCategory->name, array('class' => 'form-control')) }}
                    </div>
