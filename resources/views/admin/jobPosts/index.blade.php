...
@section('content')
    ...
    <div class="col-xs-12 wrapper wrapper-content animated fadeInLeft white-bg">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {{ Form::model($jobPosts, array('route' => array('jobPosts.search'), 'method' => 'GET','class'=>'form-inline')) }}
            ...
            <div class="col-lg-4">
                <a href="{{ route('jobPosts.create') }}" class="btn btn-info"><i class="fa fa-newspaper-o"></i>
                    &nbsp;
                    جدید</a>
                <br><br>
                    ...
                    <table class="table table-striped table-bordered table-hover" >
                        ...
                        @foreach($jobPosts as $jobPost)
                            ...
                            <tr class="gradeX">
                                ...
                                <td><strong>{{$jobPost->name }}</strong>@if($jobPost->jobs->count()) <span style="color: red;">( استفاده شده )</span> @endif</td>

                                <td style="white-space: nowrap;width:120px;">

                                    @if($jobPost->deleted_at==null )
                                        <a href="{{ route('jobPosts.edit', $jobPost->id) }}" class="btn btn-info btn-sm pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i></a>
                                    @endif

                                    @if($jobPost->deleted_at==null && !$jobPost->jobs->count())

                                        <a href="javascript:void(0);" cat_id="{{$jobPost->id}}" route="{{route('jobPosts.destroy', $jobPost->id)}}"  class="btn btn-info btn-sm pull-left btn btn-danger btn-sm pull-left confirm_alert" style="margin-right: 3px;"><i class="fa fa-trash"></i></a>

                                    @elseif($jobPost->deleted_at!=null)

                                        {!! Form::open(['method' => 'POST', 'route' => ['jobPosts.restore', $jobPost->id] ]) !!}
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            $.ajax({
                                ...
                                data: 'jobPost=' + cat_id + '&_token={{csrf_token()}}',
