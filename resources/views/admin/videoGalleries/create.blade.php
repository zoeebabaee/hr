        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ایجاد دسته بندی </h1>
                    <hr>

                    {{ Form::open(array('route' => 'video_gallery.store','files' => true)) }}
                    ...
                    <div class="form-group">
                        ...
                        <input name="icon" class="form-control icp icp-auto" value="" type="text" />
                    </div>
                    <div class="form-group">
                        {{ Form::label('name', 'نام') }}
                    ...
                    <div class="form-group">
                        {{ Form::label('cat_id', 'مجموعه والد') }}
                        <select class="form-control" name="parent_id" id="parent_id">
                            <option value="" >بدون مجموعه والد</option>
                            @foreach(\HR\VideoGallery::all() as $cat)
                                <option value="{{ $cat->id }}" {{  ($cat->id==old('parent_id')?'selected':'') }}>{{ $cat->name }}</option>
                            @endforeach
                        </select>
                    </div>
