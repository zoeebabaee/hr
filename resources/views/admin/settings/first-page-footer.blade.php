    ...
    <div class="col-xs-12 wrapper wrapper-content animated fadeInLeft white-bg">
        <div class="row">
            <div class="col-lg-12">
                ...
                {{ Form::model(null, ['route' => ['first-page-footer.update'], 'method' => 'PUT','class'=>'form','files' => true]) }}
                                ...
                                <div class="form-group">
                                    {{ Form::label('work_time', 'ساعات کاری') }}
                                    {{ Form::textarea('work_time', $setting->work_time, array('class' => 'form-control ltr-input','id'=>'body3')) }}
                                </div>

                                <div class="form-group">
                                    {{ Form::label('links', 'پیوند ها') }}
                                    {{ Form::textarea('links', $setting->links, array('class' => 'form-control ltr-input','id'=>'body4')) }}
                                </div>
