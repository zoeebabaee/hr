        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group-lg col-lg-6">
                    ...
                    <h1><i class='fa fa-user-md'></i>&nbsp;ویرایش دلیل رد</h1>
                    <hr>

                    {{ Form::model($rejectReason, ['route' => ['reject_reasons.update', $rejectReason->id], 'method' => 'PUT','class'=>'form','files' => true]) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('reason', 'دلیل') }}
                        {{ Form::text('reason', $rejectReason->reason, array('class' => 'form-control')) }}
                    </div>
