    ...
    <div class="col-xs-12 wrapper wrapper-content animated fadeInLeft white-bg">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {{ Form::model($industries, array('route' => array('industries.search'), 'method' => 'GET','class'=>'form-inline')) }}
            ...
            <div class="col-lg-4">
                ...
                <a href="{{ route('industries.create') }}" class="btn btn-info"><i class="fa fa-newspaper-o"></i>
                    &nbsp;
                    جدید</a>
                <br><br>
                        ...
                        @foreach($industries as $industry)
                            ...
                            <tr class="gradeX">
                                ...
                                <td style="white-space: nowrap;width:120px;">
                                    ...
                                    @if($industry->deleted_at==null)
                                        <a href="{{ route('industries.edit', $industry->id) }}" class="btn btn-info btn-sm pull-left" style="margin-right: 3px;"><i class="fa fa-edit"></i></a>
                                    @endif

                                    @if($industry->deleted_at==null)

                                        <a href="javascript:void(0);" cat_id="{{$industry->id}}" route="{{route('industries.destroy', $industry->id)}}"  class="btn btn-info btn-sm pull-left btn btn-danger btn-sm pull-left confirm_alert" style="margin-right: 3px;"><i class="fa fa-trash"></i></a>

                                    @else

                                        {!! Form::open(['method' => 'POST', 'route' => ['industries.restore', $industry->id] ]) !!}
