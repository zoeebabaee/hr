...
<div class="clearfix"></div>
    <div class="container">
        <div class="col-md-12">
            <fieldset>
                <legend class="font-16">جستجوی پیشرفته</legend>
            </fieldset>
            <form class="people-forms-home row" method="GET" id="search_form" action="{{route('site.jobs.index')}}">
                <div class="people-forms-fields-group col-md-12 po-input-search">
                    <input autocomplete="off" id="textinput" name="s" type="text"
                           class="people-forms-fields p-2 form-control">
                    <label class="pr-4">جستجو کنید</label>
                    <a id="singlebutton" name="singlebutton"
                       class="search-input-btn">{{ HTML::image('/site/'.config('app.site_theme').'/Template_2019/img/search.svg') }}</a>
                </div>
                <div class="col-md-4">
                    <div class="people-forms-fields-group">
                        <select id="selectbasic2" name="department[]"
                                class="people-forms-fields po-input-select form-control">
                ...
                <div class="col-md-4">
                    <div class="people-forms-fields-group">
                        <select id="selectbasic3" name="company[]"
                                class="people-forms-fields po-input-select form-control">
                            <option value="" disabled selected>انتخاب کنید</option>
                ...
                <div class="col-md-4">
                    <div class="people-forms-fields-group">
                        <select id="selectbasic1" name="province[]"
                                class="people-forms-fields po-input-select form-control">
                            <option value="" disabled selected>انتخاب کنید</option>
