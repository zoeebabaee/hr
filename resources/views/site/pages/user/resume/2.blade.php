...
<div class="container" id="scroll-resume">
    ...
    <div class="clearfix">
        <table class="ProfesstionalTrainingRecords-table"  style="direction: rtl;">
            ...
            <div class="people-forms people-forms-fields-group row">
                <div class="col-md-1"><button type="button" class="remove-row" title="Remove row"><img src="/site/default/Template_2019/img/remove-row-btn.svg"/><span></span></button></div>
                <div class="col-md-3"><div class="people-forms-fields-group"><input data-validation="required" type="text" value="{{$edu->name}}" name="ProfesstionalTrainingRecords[{{$c}}][title]" class="title people-forms-fields form-control"><label>عنوان دوره/گواهینامه تخصصی</label></div></div>
                <div class="col-md-2"><div class="people-forms-fields-group"><input data-validation="required" type="text" value="{{$edu->pivot->duration}}"  name="ProfesstionalTrainingRecords[{{$c}}][duration]" class="duration people-forms-fields form-control"><label>مدت دوره(ساعت)</label></div></div>
                <div class="col-md-2"><div class="people-forms-fields-group"><input data-validation="required number" placeholder="13xx" data-validation-allowing="negative,range[1350;1398]" data-validation-format="yyyy/mm/dd" type="text" value="{{$edu->pivot->finish_year}}" name="ProfesstionalTrainingRecords[{{$c}}][endDate]" id="ProfesstionalTrainingRecords[{{$c}}][endDate]" class="endDate people-forms-fields form-control"><label>سال اتمام</label></div></div>
                <div class="col-md-2"><div class="people-forms-fields-group"><input data-validation="required" type="text" value="{{$edu->pivot->institute_name}}" name="ProfesstionalTrainingRecords[{{$c}}][instituteName]" class="instituteName people-forms-fields form-control"><label>نام آموزشگاه/مؤسسه</label></div></div>
                <div class="col-md-2 people-forms-fields-group"><input type="checkbox" value="1" {{($edu->pivot->has_certificate==1?' checked ':'')}} name="ProfesstionalTrainingRecords[{{$c}}][hasCertificate]" id="ProfesstionalTrainingRecords[{{$c}}][hasCertificate]" class="hasCertificate"><label for="ProfesstionalTrainingRecords[{{$c}}][hasCertificate]">امکان ارائه گواهینامه</label></div>
            </div>
        ...
        <div><button type="button" class="add-row-ProfesstionalTrainingRecords add-row-btn mt-4" title="Add Row"><img src="/site/default/Template_2019/img/add-row-btn.svg"/><span>افزودن سطر جدید</span></button></div>
        <div class="col-xs-12">
            <fieldset class="red-fieldset mt-7">
                ...
                <div>
                    <table class="ForeignLanguage-table"  style="direction: rtl;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <input type="text" readonly="readonly" value="انگلیسی" name="ForeignLanguage[{{$c}}][title]" class="title people-forms-fields form-control">
                                    <label>زبان</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="ForeignLanguage[{{$c}}][speaking]" class="form-control people-forms-fields po-input-select">
                                        <option value="" {{(!is_null($english) && $english->conversation==""?'selected':'')}} ></option>
                                        <option value="1" {{(!is_null($english) && $english->conversation=="1"?' selected ':'')}}>عالی</option>
                                        <option value="2" {{(!is_null($english) && $english->conversation=="2"?' selected ':'')}}>خوب</option>
                                        <option value="3" {{(!is_null($english) && $english->conversation=="3"?' selected ':'')}}>متوسط</option>
                                        <option value="4" {{(!is_null($english) && $english->conversation=="4"?' selected ':'')}}>ضعیف</option>
                                    </select>
                                    <label>مکالمه</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="ForeignLanguage[{{$c}}][writing]" class="form-control people-forms-fields po-input-select">
                                        <option value="" {{(!is_null($english) && $english->writing==""?' selected ':'')}}></option>
                                        <option value="1" {{(!is_null($english) && $english->writing=="1"?' selected ':'')}}>عالی</option>
                                        <option value="2" {{(!is_null($english) && $english->writing=="2"?' selected ':'')}}>خوب</option>
                                        <option value="3" {{(!is_null($english) && $english->writing=="3"?' selected ':'')}}>متوسط</option>
                                        <option value="4" {{(!is_null($english) && $english->writing=="4"?' selected ':'')}}>ضعیف</option>
                                    </select>
                                    <label>نگارش</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="ForeignLanguage[{{$c}}][comprehension]" class="form-control people-forms-fields po-input-select">
                                        <option value="" {{(!is_null($english) && $english->comprehension==""?' selected ':'')}}></option>
                                        <option value="1" {{(!is_null($english) && $english->comprehension=="1"?' selected ':'')}}>عالی</option>
                                        <option value="2" {{(!is_null($english) && $english->comprehension=="2"?' selected ':'')}}>خوب</option>
                                        <option value="3" {{(!is_null($english) && $english->comprehension=="3"?' selected ':'')}}>متوسط</option>
                                        <option value="4" {{(!is_null($english) && $english->comprehension=="4"?' selected ':'')}}>ضعیف</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="people-forms-fields-group">
                                    <input data-validation="" type="text" value="{{(!is_null($english) ?$english->certificate:'')}}" name="ForeignLanguage[{{$c}}][Certificate]" class="Certificate people-forms-fields form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="ForeignLanguage[{{$c}}][speaking]" class="form-control people-forms-fields po-input-select">
                                        ...
                                        <option value="1"{{($edu->conversation==1?' selected ':'')}}>عالی</option>
                                        <option value="2"{{($edu->conversation==2?' selected ':'')}}>خوب</option>
                                        <option value="3"{{($edu->conversation==3?' selected ':'')}}>متوسط</option>
                                        <option value="4"{{($edu->conversation==4?' selected ':'')}}>ضعیف</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="ForeignLanguage[{{$c}}][comprehension]" class="form-control people-forms-fields po-input-select">
                                        ...
                                        <option value="1"{{($edu->comprehension==1?' selected ':'')}}>عالی</option>
                                        <option value="2"{{($edu->comprehension==2?' selected ':'')}}>خوب</option>
                                        <option value="3"{{($edu->comprehension==3?' selected ':'')}}>متوسط</option>
                                        <option value="4"{{($edu->comprehension==4?' selected ':'')}}>ضعیف</option>
                                    </select>
                                    <label>درک مطلب</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="people-forms-fields-group">
                                    <input data-validation="" type="text" value="{{$edu->certificate}}" name="ForeignLanguage[{{$c}}][Certificate]" class="Certificate people-forms-fields form-control">
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div><button type="button" class="add-row-ForeignLanguage add-row-btn mt-4" title="Add Row"><img src="/site/default/Template_2019/img/add-row-btn.svg"/><span>افزودن سطر جدید</span></button></div>
                </div>
            </div>
        </div>
        <div class="col-xs-12">
                ...
                <div>
                    <table class="computerSkill-table"  style="direction: rtl;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="people-forms-fields-group">
                                    <input data-validation="required" type="text" value="{{$edu->name}}" name="computerSkill[{{$c}}][title]" class="title form-control people-forms-fields">
                                    <label>نام نرم افزار</label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="computerSkill[{{$c}}][proficiency]" class="form-control people-forms-fields po-input-select">
                                        <option value=""{{($edu->pivot->proficiency==""?'':'')}}></option>
                                        <option value="1"{{($edu->pivot->proficiency==1?' selected ':'')}}>عالی</option>
                                        <option value="2"{{($edu->pivot->proficiency==2?' selected ':'')}}>خوب</option>
                                        <option value="3"{{($edu->pivot->proficiency==3?' selected ':'')}}>متوسط</option>
                                        <option value="4"{{($edu->pivot->proficiency==4?' selected ':'')}}>ضعیف</option>
                                    </select>
                                    <label>میزان تسلط</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="people-forms-fields-group">
                                    <input type="text" value="{{$edu->pivot->description}}" name="computerSkill[{{$c}}][description]" class="description people-forms-fields form-control">
                                    <label>توضیحات</label>
                                </div>
                            </div>
                            <div class="col-md-3 people-forms-fields-group">
                                <input type="checkbox" {{($edu->pivot->has_certificate==1?' checked ':'')}} name="computerSkill[{{$c}}][Certificate]" id="certifi_[{{$c}}][Certificate]_4" value="1">
                    ...
                    <div><button type="button" class="add-row-computerSkill add-row-btn mt-4" title="Add Row"><img src="/site/default/Template_2019/img/add-row-btn.svg"/><span>افزودن سطر جدید</span></button></div>
                </div>
            </div>
        </div>
        <div class="col-xs-12">
            ...
            <div class="col-xs-12 no-padd no-padd-xs">
                <div>
                    <table class="experimental-table"  style="direction: rtl;">
                        ...
                        <div class="row">
                            <div class="col-md-1"><button type="button" class="remove-row" title="Remove row"><img src="/site/default/Template_2019/img/remove-row-btn.svg"/><span></span></button></div>
                            <div class="col-md-4"><div class="people-forms-fields-group"><input data-validation="required" type="text" value="{{$edu->name}}" name="experimental[{{$c}}][title]" class="title people-forms-fields form-control"><label>عنوان</label></div></div>
                            <div class="col-md-3">
                                <div class="people-forms-fields-group">
                                    <select data-validation="required" name="experimental[{{$c}}][proficiency]" class="form-control people-forms-fields po-input-select">
                            ...
                            <div class="col-md-4">
                                <div class="people-forms-fields-group">
                                    <input type="text" value="{{$edu->pivot->description}}" name="experimental[{{$c}}][description]" class="description people-forms-fields form-control">
                                    <label>توضیحات</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div><button type="button" class="add-row-experimental add-row-btn mt-4" title="Add Row"><img src="/site/default/Template_2019/img/add-row-btn.svg"/><span>افزودن سطر جدید</span></button></div>
                </div>
            </div>
        </div>
    </div>
    <fieldset class="mt-5 w-100">
        <legend class="text-left">
            <input type="submit" class="save send-btn-green" title="ذخیره و ادامه" value="<?= (Auth::user()->complete_percent != 31)?'ذخیره و ادامه':'ذخیره' ?>" >
        </legend>
    </fieldset>
    {{Form::close()}}
</div>
