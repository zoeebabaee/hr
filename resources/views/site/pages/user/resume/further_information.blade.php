...
@section('custom_css')
    ...
    <style>
        ...
        .textarea-rtl{
            text-align: right;direction:rtl;height: 200px;
        }
    </style>
...
@section('content')
    <div class="cd-main-content cd-inner-content">
        ...
        <div class="col-xs-12 top-innerpage" style="background:url('{{Auth::user()->cover}}') no-repeat top center/cover;">
            <div class="container"
        ...
        <div class="clearfix container inner-content">
            <div class="col-xs-12 wrap-content">
                ...
                {{ Form::open(array('method'=>'PUT','route' => 'user.resume.further_information.store','files' => true,'onsubmit'=>'return check_employment()')) }}
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 left-jobs no-padd-xs no-padd-l" id="scroll-resume">
                    ...
                    @endif
                    <h3>رزومه من</h3>
                    <h4 style="margin-bottom: 15px;">ارائه اطلاعات تکمیلی </h4>
                                    ...
                                    <table class="family-table">
                                        ...
                                        @if($resume->family->count()==0)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" value="" name="Family[{{$c}}][name]" class="name form-control">
                                                </td>
                                                <td>
                                                    <div class="col-xs-12 no-padd no-padd-xs">

                                                        <select data-validation="required" data-placeholder="یک گزینه انتخاب کنید" name="Family[{{$c}}][relation]" class="relation-select form-control" >
                                                ...
                                                <td class="job_col">
                                                    <input type="text" value="" id="job_{{$c}}" name="Family[{{$c}}][job]" class="job form-control">
                                                    <input type="checkbox"  id="unemployed_{{$c}}" name="Family[{{$c}}][unemployed]" class="unemployed"> عدم اشتغال
                                                </td>
                                                <td class="organization_col">
                                                    <input type="text"  value="" id="organization_{{$c}}" name="Family[{{$c}}][organization]" class="organization  form-control">
                                                </td>
                                            </tr>
                                        @else
                                            @foreach($resume->family as $family)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input data-validation="required" type="text" value="{{$family->name}}" name="Family[{{$c}}][name]" class="name form-control">
                                                    </td>
                                                    <td>
                                                        <div class="col-xs-12 no-padd no-padd-xs">

                                                            <select data-validation="required" data-placeholder="یک گزینه انتخاب کنید" name="Family[{{$c}}][relation]" class="relation-select form-control" >
                                                                <option value=""{{($family->relation==0?' selected ':'')}}>یک گزینه را انتخاب کنید</option>
                                                    ...
                                                    <td class="job_col">
                                                        <input type="text" {{($family->job==null?' disabled ':'')}} value="{{$family->job}}" id="job_{{$c}}" name="Family[{{$c}}][job]" class="job form-control">
                                                        <input type="checkbox" {{($family->job==null?' checked ':'')}}  id="unemployed_{{$c}}" onclick="unemployed({{$c}});" name="Family[{{$c}}][unemployed]" class="unemployed"> عدم اشتغال
                                                    </td>
                                                    <td class="organization_col">
                                                        <input type="text"  {{($family->job==null?' disabled ':'')}} value="{{$family->organization}}" id="organization_{{$c}}" name="Family[{{$c}}][organization]" class="organization  form-control">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                    ...
                    <div class="col-md-12 no-padd no-padd-xs text-left">
                        <input type="submit" class="save" title="ذخیره و ادامه" value="ذخیره و ادامه">
                    </div>
        ...
        <script>
            ...
            function unemployed(id){
                ...
                if(chk){
                    ...
                    $('#job_'+id).val('');$('#organization_'+id).val('');
                }else{
                    $('#job_'+id).val(job);
