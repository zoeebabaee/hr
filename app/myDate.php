...
class myDate {
    ...
    /**
     * Create a myDate instance from a Carbon one
     *
     * @param Carbon $carbon
     *
     * @return static
    ...
    /**
     * Get a myDate instance for current date and time
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a myDate instance for today
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a myDate instance for tomorrow
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a myDate instance for yesterday
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a myDate instance for the greatest supported date.
     *
     * @return myDate
     */
    ...
    /**
     * Create a myDate instance for the lowest supported date.
     *
     * @return myDate
     */
    ...
    /**
     * Create a myDate instance from a specific format
     *
     * @param string                   $format
     * @param string                   $date
     * @param DateTimeZone|string|null $tz
    ...
    /**
     * Create an instance of myDate based an a Carbon instance
